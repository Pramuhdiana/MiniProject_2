...
@endif
      ...
      <div class="col-md-8">
        <div class="card-body">
            ...
            <a href="/user/dosenedit/{{ Auth::guard('dosen')->user()->id }}" class="btn btn-primary">Edit Akun</a>
            ...
            <a href="/user/editmahasiswa/{{ Auth::guard('mahasiswa')->user()->id }}" class="btn btn-primary">Edit Akun</a>
            @endif
        </div>
      </div>
    </div>
